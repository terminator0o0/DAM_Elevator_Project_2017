...
${OBJECTDIR}/pcanProjCon.o: pcanProjCon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../../Downloads/mysql-connector-c++-1.1.8-linux-ubuntu16.10-x86-64bit/include -I../../Downloads/mysql-connector-c++-1.1.8-linux-ubuntu16.10-x86-64bit/include/cppconn -I../../Downloads/boost_1_64_0 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pcanProjCon.o pcanProjCon.cpp
